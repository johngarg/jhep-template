...
Bibliographic citations can be done with cite: refs.~\cite{Weinberg:1967tq,
Weinberg:2020zba}.  When possible, align equations on the equal sign. The
package \texttt{amsmath} is already loaded. See \eqref{eq:x}.
\begin{equation}
\label{eq:x}
\begin{split}
x &= 1 \,,
...
\includegraphics[width=.5\textwidth]{tikz1.pdf}
